...
constexpr auto DISPLAY_GRAVGRID = UINT32_C(0x00004000); // Gravity field as deformed grid (spacetime-curvature style)
constexpr auto DISPLAY_AIR     = UINT32_C(0x0000778F); // 'or' of all air modes (incl. GRAVGRID)
