...
void OptionsController::SetPressureBreakEnabled(bool state)
{
	model->SetPressureBreakEnabled(state);
}

bool OptionsController::GetPressureBreakEnabled()
{
	return model->GetPressureBreakEnabled();
}
